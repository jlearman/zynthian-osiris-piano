...
DST_DIR="$ZYNTHIAN_DATA_DIR/soundfonts/sfz/Pianos/Zynthian Osiris Piano"
# DST_DIR="/tmp/j2/Zynthian Osiris Piano" #### TESTING ONLY
DOWNLOAD_URL="https://github.com/jlearman/zynthian-osiris-piano/archive/refs/heads/main.zip"
